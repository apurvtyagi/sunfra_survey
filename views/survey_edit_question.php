<div class="question" data-question_id="<?php if (empty($question)) {
  ...
  <div>
    ...
    echo $question->getUniqueId();
      ...
      <option value="input"<?php if (! empty($question) && $question->question_type == 'input'): ?> selected="selected"<?php endif; ?>>Text</option>
      <option value="radio"<?php if (! empty($question) && $question->question_type == 'radio'): ?> selected="selected"<?php endif; ?>>Radio</option>
      <option value="checkbox"<?php if (! empty($question) && $question->question_type == 'checkbox'): ?> selected="selected"<?php endif; ?>>Checkbox</option>
      <option value="textarea"<?php if (! empty($question) && $question->question_type == 'textarea'): ?> selected="selected"<?php endif; ?>>Textarea</option>
    </select>
