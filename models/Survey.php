...
class Survey extends Model
{
    ...
    public function getSurveyResponsesAPI(PDO $pdo,$surveyId,$getQuestions)
    {
        $driver = $pdo->getAttribute(PDO::ATTR_DRIVER_NAME);
        $groupConcatSql = 'group_concat';
